...
ARG FEATURES=""
ARG POSTGRES_URI="postgres://inventarwerk:inventarwerk@host.docker.internal:host-gateway:5432/inventarwerk"
...
RUN cargo sqlx migrate run --source inv_rep/migrations
